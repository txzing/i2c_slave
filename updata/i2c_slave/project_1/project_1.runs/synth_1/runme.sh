...
HD_PWD='C:/Users/tangx/Desktop/Test_3EG/i2c_slave/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log i2c_slave.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source i2c_slave.tcl
