...
HD_PWD='D:/workdir/TEST_2CG/tx/desay_imx623/vivado/ip_repo/ip/fake_sensor_imx623/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fake_sensor_imx623.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fake_sensor_imx623.tcl
