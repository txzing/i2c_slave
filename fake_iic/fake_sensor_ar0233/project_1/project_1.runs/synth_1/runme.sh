...
HD_PWD='C:/Users/txzing/Desktop/fake_sensor_ar0233/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fake_sensor_ar0233.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fake_sensor_ar0233.tcl
